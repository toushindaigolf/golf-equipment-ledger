...
export default function App() {
  ...
  const migration = useEquipmentMigration({ userId: auth.user?.id, configured: auth.configured, authLoading: auth.loading, onMigrated: equipment.reload });
